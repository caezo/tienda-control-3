...
path('registro', registro, name='registro'),
    ...
    path('usuarios/<str:accion>/<int:id>', usuarios, name='usuarios'),
    ...
    path('eliminar_producto_en_bodega/<int:id>/', eliminar_producto_en_bodega, name='eliminar_producto_en_bodega'),
